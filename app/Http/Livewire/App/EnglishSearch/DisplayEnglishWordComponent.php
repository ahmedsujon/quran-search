...
class DisplayEnglishWordComponent extends Component
{
    ...
    {
        $display_complete_quran_word = AyatWord::orderBy('english_word_subject_category')->orderBy('english_word_subject_category')->where('english_word_sub_subject_category', 'like', '%'.$this->displayCompleteQuraWord.'%')
