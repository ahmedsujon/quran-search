...
class DropdownSearchComponent extends Component
{
    ...
    {
        $search_dropdowns = AyatWord::orderBy('english_word_subject_category', 'ASC')->orderBy('english_word_sub_subject_category', 'ASC')->where('english_word_sub_subject_category', 'like', '%' . $this->dropdownsearch . '%')->paginate($this->sortingValue);
