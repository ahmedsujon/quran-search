    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Select Value of Arabic Search </h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboards</a></li>
                        <li class="breadcrumb-item active">Select Value of Arabic Search</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Values of Arabic Searches</h4>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive table-card">
                    <table class="table table-borderless table-centered align-middle">
                        ...
                        <tbody>
                            @if ($arabic_dropdowns->count() > 0)
                                @foreach ($arabic_dropdowns as $index => $dropdown)
                                    <tr>
                                        <td>{{ $index +1 }}</td>
                                        <td>{{ $dropdown->name }}</td>
            ...
            {{ $arabic_dropdowns->links('pagination-links-table') }}
        </div>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myModalLabel">ADD DROPDOWN SEARCHES VALUE</h5>
